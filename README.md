...
<img width="800" alt="Brain Dump 2.0 Hero" src="./docs/screenshots/01-hero.png" />
<p><em>Kinetic logo with parallax floating symbols</em></p>

<img width="800" alt="Brain Dump 2.0 Input" src="./docs/screenshots/02-input.png" />
<p><em>Glowing input section with animated agent mascots</em></p>

<img width="800" alt="Meet the Crew" src="./docs/screenshots/03-agents.png" />
<p><em>Meet the 5-agent crew: Listie, Linky, Wordy, Sparky, and Blendy</em></p>

<img width="800" alt="HITL Clarification Modal" src="./docs/screenshots/04-hitl-modal.png" />
<p><em>Human-in-the-Loop ambiguity detection modal</em></p>

<img width="800" alt="Processing Theater" src="./docs/screenshots/05-processing.png" />
<p><em>Theatrical processing view with agent progress indicators</em></p>

<img width="800" alt="Final Results" src="./docs/screenshots/06-results.png" />
<p><em>Actionable insights with "Nailed It" feedback loop</em></p>
